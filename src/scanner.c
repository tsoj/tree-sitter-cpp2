...
void *tree_sitter_cpp2_external_scanner_create() {
    Scanner *scanner = (Scanner *)ts_calloc(1, sizeof(Scanner));
    memset(scanner, 0, sizeof(Scanner));
    return scanner;
}

bool tree_sitter_cpp2_external_scanner_scan(void *payload, TSLexer *lexer, const bool *valid_symbols) {
...
unsigned tree_sitter_cpp2_external_scanner_serialize(void *payload, char *buffer) {
...
void tree_sitter_cpp2_external_scanner_deserialize(void *payload, const char *buffer, unsigned length) {
